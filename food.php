    ...
    <section class="blog-post section-header-offset">
        <div class="blog-post-container container">
            <div class="blog-post-data">
                <h3 class="title blog-post-title">FOOD</h3>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="news-posts-grid-wrapper d-grid">
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\food3.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\food4.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\food5.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\food6.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\food7.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\food8.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\food9.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\food010.jpg" alt="" class="article-image">
                    </div>
