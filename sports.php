    ...
    <section class="blog-post section-header-offset">
        <div class="blog-post-container container">
            <div class="blog-post-data">
                <h3 class="title blog-post-title">SPORTS</h3>
            </div>
        </div>
    </section>
    ...
    <section class="news-posts section">
        ...
        <div class="container">
            ...
            <div class="news-posts-grid-wrapper d-grid">
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\SportsA.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\SportsB.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\SportsC.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\SportsD.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\SportsE.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\SportsF.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\SportsG.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="#" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\SportsH.jpg" alt="" class="article-image">
                    </div>
