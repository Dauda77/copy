    ...
    <section class="blog-post section-header-offset">
        <div class="blog-post-container container">
            <div class="blog-post-data">
                <h3 class="title blog-post-title">News</h3>
            </div>
        </div>
    </section>
    ...
    <section class="news-posts section">
        ...
        <div class="container">
            ...
            <div class="news-posts-grid-wrapper d-grid">
                ...
                <a href="post.php" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\nature.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="archipost.php" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\building.jpg" alt="" class="article-image">
                    </div>
                ...
                <a href="post.php" class="article d-grid">
                    <div class="news-posts-article-image-wrapper">
                        <img src="imgs\art.jpg" alt="" class="article-image">
                    </div>
